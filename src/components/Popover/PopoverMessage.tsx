              ...
              <Dialog.Panel className="container-bg w-full max-w-md sm:max-w-lg transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="flex justify-evenly mt-4">
                  ...
                  >
                    <a
                      href={
                        message.actionButton1?.url ||
                        "https://mail.google.com/mail/u/0/?fs=1&to=rami.rami@ucalgary.ca&su=About...&body=Hey%Rami,%20....&tf=cm"
                      }
                    >
                      {message.actionButton1?.text || "Email me"}
                    </a>
                  </button>
                  <button
                    type="button"
                    ...
                    onClick={closeModal}
                  >
                    <a href={message.actionButton2?.url || "https://www.linkedin.com/in/rami--maalouf/"}>
                      {message.actionButton2?.text || "Let's connect"}
                    </a>
                  </button>
                </div>
              </Dialog.Panel>
